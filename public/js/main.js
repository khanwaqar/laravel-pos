...
function closeEl(removeParentDiv='', removeClass='') {
    $(removeParentDiv).removeClass("show");
...
function hideField() {
    ...
    var hasVarient = document.getElementById("hasVariant");
    if (hasVarient.checked == false) {
        // document.getElementById("hasVariant").value = 0;  
