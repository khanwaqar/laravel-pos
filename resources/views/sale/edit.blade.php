...
<div class="content-wrapper" ng-app="flexiblepos">
    ...
    <section class="content-header"><h1>{{__('Sales')}}</h1></section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                <div class="box-header"><h3 class="box-title"> {{__('Edit Sale')}}</h3></div>
            </div>
            <div class="box box-success">
...
<div class="modal sub-modal" id="addCustomerModal">
