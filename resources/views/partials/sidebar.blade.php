...
<aside class="main-sidebar">
  ...
  <ul class="sidebar-menu pt-md-5 mt-6" data-widget="tree">
...
<!-- <li><a href="{{ url('/item-kits') }}">{{trans('menu.item_kits')}}</a></li> -->
    ...
    @if(config('fpos.demo'))
    <div class="mt-5">
      <a href="https://codecanyon.net/item/flexiblepos-with-inventory-management-system/23633865"><img src="{{asset('images/side_banner.jpg')}}" class="img-responsive w-100" alt=""></a>
    </div>
    @endif
</section>
</aside>
