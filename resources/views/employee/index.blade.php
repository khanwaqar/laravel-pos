    ...
    <section class="content-header m-3">
      <h1>{{__('Employees')}}
        ...
        <a class="btn btn-small btn-primary pull-right left-margin-10" href="#addEmployeeModal" data-toggle="modal"><i class="fa fa-plus"></i> {{trans('employee.new_employee')}}</a>
          ...
          @endif
          <a class="btn btn-small btn-info pull-right left-margin-10" href="{{route('permissions.list')}}"><i class="fa fa-plus"></i> {{__('Permissions')}}</a></h1>
    </section>
...
<div class="modal sub-modal" id="addEmployeeModal">
