...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="modal sub-modal" id="addItemModal">
        <div class="modal-dialog modal-lg">
            @include('item.form', ['item'=>''])
        </div>
      </div>
      <div class="modal sub-modal" id="editItemModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="editItem"></div>
        </div>
      </div>
      <div class="modal sub-modal" id="inventoryModal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="inventory"></div>
        </div>
      </div>
      <div class="modal sub-modal" id="itemAttributeModal">
        <div class="modal-dialog modal-lg">
