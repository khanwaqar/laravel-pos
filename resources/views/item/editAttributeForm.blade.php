<div class="row" id="editAttributeForm">
    ...
    <div class="col-sm-6">
        <div class="form-group row">
            {{ Form::label('name', 'Item', ['class'=>'col-sm-3 text-right pr-0'])}}
            <div class="col-sm-9"> 
      ...
      <div class="form-group row">
          ...
          <div class="col-sm-9">
              <label class="switch">
                <input type="checkbox" name="status" id="status" value="1" {{ !empty($attribute) && $attribute->status == 1 ? 'checked' : ''}}>
    ...
    <div class="col-sm-6 pl-0">
      ...
      <div class="form-group row">
        {{ Form::label('exp_date', __('Expire Date'), ['class'=>'col-sm-3 pr-0 text-right']) }}
        <div class="col-sm-9"> 
